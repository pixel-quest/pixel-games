...
function StartGame(gameJson, gameConfigJson)
    ...
    CAudio.PlayVoicesSync("tetris/tetris_gamename.mp3")

    AL.NewTimer(CAudio.GetVoicesDuration("tetris/tetris_gamename.mp3")*1000, function()
...
CGameMode.StartGame = function()
    ...
    CAudio.PlayMusic("tetris/tetris_bgsong.mp3")
...
CGameMode.PlayerClearedLines = function(iPlayerID, iLinesCleared)
    ...
    CAudio.PlaySystemAsync("tetris/tetris_clear_"..iLinesCleared.."_line.mp3")
end
...
CTetris.MoveAllActiveDown = function()
    ...
    CAudio.PlaySystemAsync("tetris/tetris_movedown.mp3")
end
...
CTetris.PlaceActiveBlock = function(iPlayerID)
    ...
    if iLinesCleared > 0 then
        ...
        CAudio.PlaySystemAsync("tetris/tetris_place.mp3")
    end
...
CTetris.ButtonRotateActive = function(iPlayerID)
    ...
    if CTetris.CheckActiveCanMove(iPlayerID, 0, 0, 1) then
        ...
        CAudio.PlaySystemAsync("tetris/tetris_rotate.mp3")
    end
