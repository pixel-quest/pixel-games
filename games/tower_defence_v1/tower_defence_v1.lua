...
Сложности:
    ...
    Уровни:
    1 - "Very Easy" - для одного игрока
    2 - "Easy" - легкий для новичков
    3 - "Medium" - средний для тех кто уже играл
    4 - "Hard" - испытание для самых быстрых
    5 - "Ultra Hard" - для большого количества людей
    6 - "Ultra Hardcore" - для большого количества людей
